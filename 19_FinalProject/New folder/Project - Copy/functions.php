...
$db_username = 'id16659161_pendekinn_db';
$db_password = 'tipPo49d]-yYA&Cy';
$database = 'id16659161_pendekinn'; 
...
{
    return (preg_match("/pendekinn\.000webhostapp/i", $url)) ? true : false; // Match it to our domain.
}
